...
class _WeeklySummaryScreenState extends State<WeeklySummaryScreen> {
  List<double> availabilities = List.filled(7, 1.0); // Mon to Sun
  double avg = 1.0;
  bool isLoading = true;
  ...
  Future<void> fetchData() async {
    ...
    try {
      final response = await http.get(Uri.parse('http://10.0.2.2:5000/daily_availability'));
